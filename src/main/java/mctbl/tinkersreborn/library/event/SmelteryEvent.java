...
public class SmelteryEvent extends Event {
    ...
    public TinkersRebornInventoryLogic component;
    public int x, y, z;

    public SmelteryEvent(TinkersRebornInventoryLogic component, int x, int y, int z) {
    ...
    public static class ItemInsertedIntoCasting extends SmelteryEvent {
        ...
        public ItemInsertedIntoCasting(TinkersRebornInventoryLogic component, int x, int y, int z, ItemStack item,
            EntityPlayer player) {
    ...
    public static class ItemRemovedFromCasting extends SmelteryEvent {
        ...
        public ItemRemovedFromCasting(TinkersRebornInventoryLogic component, int x, int y, int z, ItemStack item,
            EntityPlayer player) {
            super(component, x, y, z);
            this.item = item;
            this.player = player;
