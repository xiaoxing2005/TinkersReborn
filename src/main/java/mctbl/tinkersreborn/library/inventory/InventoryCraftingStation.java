...
public class InventoryCraftingStation extends InventoryCrafting {
    ...
    private final TinkersRebornInventoryLogic logic;

    public InventoryCraftingStation(Container par1Container, int size, int height, TinkersRebornInventoryLogic logic) {
