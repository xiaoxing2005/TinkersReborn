...
public class ProjectileBaseRenderer<T extends EntityProjectileBase> extends Render {

    protected static ToolRender toolCoreRender = new ToolRender();
    ...
    public void doRender(T entity, double x, double y, double z, float p_76986_8_, float p_76986_9_) {
        ...
        toolCoreRender.renderItem(IItemRenderer.ItemRenderType.ENTITY, entity.getEntityItem());
        GL11.glTranslatef(0.0f, 0.25f, 0);
    ...
    protected ResourceLocation getEntityTexture(Entity par1Entity) {
        return this.func_110796_a((EntityProjectileBase) par1Entity);
    }

    protected ResourceLocation func_110796_a(EntityProjectileBase par1ArrowEntity) {
        return this.renderManager.renderEngine.getResourceLocation(
            par1ArrowEntity.getEntityItem()
                .getItemSpriteNumber());
    }
